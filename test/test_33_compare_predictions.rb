...
class Test33ComparePredictions < Test::Unit::TestCase
  ...
  def test_scenario1
    ...
    data = [
           ['data/spam.csv', {"fields"=> {"000001"=> {"optype": "text", "term_analysis"=> {"case_sensitive"=> true, "stem_words"=> true, "use_stopwords"=> false, "language"=> "en"}}}}, {"Type"=> "ham", "Message"=> "Mobile call"}, 'Cluster 7', 0.36637],
           ...
           ['data/spam.csv', {"fields"=> {"000001"=> {"optype"=> "text", "term_analysis"=> {"case_sensitive"=> true, "stem_words"=> true, "use_stopwords"=> false, "language"=> "en"}}}}, {"Type"=> "", "Message"=> ""}, 'Cluster 1', 0.5],
  ...
  def test_scenario4
     ...
     data = [[File.dirname(__FILE__)+'/data/spam.csv', {"fields" => {"000001" => {"optype": "text", "term_analysis" => {"case_sensitive" => true, "stem_words" => true, "use_stopwords" => false, "language" => "en"}}}}, {"Type" => "ham", "Message" => "Mobile call"}, [0.01878, 0.00388, 0.00388, 0.00388, 0.20313, 0.47315, 0.00574, 0.05695, 0.00388, 0.19382, 0.00388, 0.02902]],
     ...
     data.each do |filename, options, data_input, topic_distribution_result|
        ...
        #assert_equal(1, topic_distribution["object"]["status"]["code"])
